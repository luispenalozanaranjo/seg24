			...
			<tr>
				<td colspan="3">
					<table width="600" border="0" align="center">
						...
						<tr><td align="left">Dpto/ Población</td><td>:</td><td align="left">'.$poblacion.'</td></tr>
...
$html.='				<tr><td align="right">Otra</td>
			...
			<tr><td colspan="3"><table width="650" border="0" cellspacing="0" cellpadding="10"  bordercolor="#000000" background="">
	<tr>
	  <td >
		<table width="600"  border="0" align="center">
			<tr>
				...
				<td colspan="3">
					<table width="600" border="1" align="center" cellpadding="10">
						<tr style="line-height: 100%;">
							<td align="justify">'.nl2br($infoadicional, false).'</td>
						</tr>
					</table>
				</td>
			</tr>	
			<tr><td colspan="3">&nbsp;</td></tr>
			<tr>
				<td width="100%" align="center"><br><br><br><br>________________________</td>
			</tr>	
			<tr>
